...
function eliminarInfo() {
  const cardData = document.getElementsByClassName("container");
...
`;
  ...
  const containerSection = document.querySelector(".container.card-bg");
  containerSection.classList.add("container2");
}
